...
CREATE TABLE IF NOT EXISTS Tbl_Agentes (
  ...
  Solicitando_Transmision VARCHAR(45) NOT NULL,
...
INSERT INTO `tbl_agentes` (`PK_ID_Agente`, `Nombre_Agente`,`Token_Dispositivo`,`Estado`,`Solicitando_Transmision`) VALUES
(1, 'Juan','ePzR-_EUeFE:APA91bGB8e00--CuA8TzsqIPu07_mmCwGZq7mlIi2N_9iMiDvBDqzTIw7_6fz2AciNT1ODj1vzIB2unhf6TTsL4DitZdELNeSlAFyNVdtUca88cy3XR4Duoboin8tKdnmUUHai_Efzab','Desconectado','NO'),
(2, 'Maik','fcpM3mpC-k0:APA91bHcwj9czUKIgfLqmPmIJ3r8L2XEw8Ntcp6yAvL0hS8p8Pdr_M4gtB-eK3y7SucS0zB50HJOM6TwKQb8LnkFT_DmlAFYy8SjL3QnyP-ufPsaTjeqMwqZhWF9CK-Mug6dPntWSPbM','Desconectado','NO'),
(3, 'TIPI','fo8qOzn6lk4:APA91bHhPWf9rc8cQ93bQNUAN0P-8AsidnIIZ-dmdki_fo21ELVzvwgbzqJYqUzSZPZMczMmDmgXPBPuTum9Wzb6RKUOzO5WAQVPSVPBnl6u3vaZi6nGnqkFjKZh1Ony2fe-Xl4MvHRa','Desconectado','NO');
